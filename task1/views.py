        ...
        try:
            ...
            res = {
                "Content":{
                    ...
                    "Task_id": task_id,
                    "url": tbl.url,
                    "pending_task" : tbl_page_data.objects.filter(status_process=tbl_page_data.PROCESSING_STATUS).count(),# (show us the total number of pending task in queue forthis API)
